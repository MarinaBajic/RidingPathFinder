...
public class RoadController {
    ...
    @GetMapping("/path")
    public ResponseEntity<GeoJson> getPath(@RequestParam Integer startId, @RequestParam Integer endId) {
        return ResponseEntity.ok(roadService.findPathBetweenWaypoints(startId, endId));
    }
